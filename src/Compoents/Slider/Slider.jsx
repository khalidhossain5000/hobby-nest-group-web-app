        ...
        <SwiperSlide>
            <div className="relative h-[100vh] w-full">
                ...
                <div className="absolute inset-0 bg-[#00000091] flex flex-col justify-center items-center text-white text-center p-6">
                    <h2 className="lg:text-6xl font-bold text-[#fef0ff]">Find Your People With Hobby Hub</h2>
      ...
      {/* slider - 2 */}
        <SwiperSlide>
            <div className="relative h-[100vh] w-full">
                ...
                {/* text and black overlay */}
                <div className="absolute inset-0 bg-[#00000091] flex flex-col justify-center items-center text-white text-center p-6">
                    <h2 className="lg:text-6xl font-bold text-[#fef0ff]">Turn Your Hobbies Into FriendShip!</h2>
        ...
        <SwiperSlide>
            <div className="relative h-[100vh] w-full">
                ...
                {/* text and black overlay */}
                <div className="absolute inset-0 bg-[#00000091] flex flex-col justify-center items-center text-white text-center p-6">
                    <h2 className="lg:text-6xl font-bold text-[#fef0ff]">Your Next Hobbie Adventure Start Here With Us</h2>
