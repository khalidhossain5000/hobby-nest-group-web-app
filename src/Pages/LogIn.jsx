                    ...
                    <div className="card-body">
                        <form onSubmit={handleLogin} className='flex flex-col justify-center items-center'>
                            ...
                            <div className='pt-3 w-9/12'>
                                ...
                                <Link  to='/auth/forget-password' className="text-left text-[16px] link link-hover text-pink-300">Forgot password?</Link>
                            </div>
                        ...
                        <div>
                            <h5 className='w-9/12 mx-auto text-xl text-gray-300'>Don't have an account? <Link  to='/auth/register' className='text-pink-600 font-bold'>Register</Link> Here</h5>
                        </div>
                    </div>
                </div>
            </div>
